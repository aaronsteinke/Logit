...
class ConnectController extends Zend_Controller_Action {
	...
	public function facebookauthAction() {
		...
		$url = 'https://graph.facebook.com/oauth/authorize?client_id=' . Zend_Registry::get('facebook_client_id') . '&redirect_uri=' . Zend_Registry::get('facebook_redirect_uri') . '&scope=user_checkins,user_events,user_location,user_photos,email, offline_access';
