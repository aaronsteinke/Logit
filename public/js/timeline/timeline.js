...
function sendImageRequest(){
	setDateDifference();
	howMuchImages();
	$('#imagewindow').load('map/get-images-for-timeline/number-of-images/' + "20" + "/first-date/" + firstDate.toString('yyyy-M-d') + "/first-time/"+ firstDate.toString('HH:mm') + "/second-date/" + secondDate.toString('yyyy-M-d') + "/second-time/"+ secondDate.toString('HH:mm'));
}